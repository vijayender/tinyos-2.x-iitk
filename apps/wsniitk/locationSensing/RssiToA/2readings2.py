...
if __name__ == "__main__":
    fil = sys.argv[1]
    mat = genfromtxt(fil)
    mat2 = zeros((mat.shape[0]/10,mat.shape[1]+3))
    a = concatenate((arange(0.5,2,0.5),array([0]),arange(2,10,0.5),arange(10,20),[0],arange(19,51),[0]*2))
    b = concatenate (([0],arange(0.5,10,0.5),arange(10,51)))
    c = arange(1,51)
    lens = concatenate((a,b,[0],c,[0]))
